...
<style>
    section.search-results-widget .search-result .search-result-title h3{
        min-height: 80px;
    }
</style>
		...
		<div id="search-col" class="col-xl-10 col-md-12 col-sm-16">
			<header class="row">
				<div class="search-bar col-xl-16">
					<h2 class="portlet-title-text sr-only portlet-title-editable">GCSE  Search Test</h2>
					<div class="row">
						...
						<div class="col-md-5 col-xs-16">
							<button class="search-bar-submit search-button" style="position: unset; right: 0em; top: auto; transform: translateY(25%);">Update Search</button>
						</div>
					</div>
				</div>
			</header>
