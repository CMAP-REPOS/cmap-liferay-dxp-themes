<#if entries?has_content>
  ...
  <nav id="cmap-2019-breadcrumbs" class="breadcrumb-cmap container-fluid" aria-label="Breadcrumb">
    <#assign cssClass="" />
    <div class="row">
      <div class="share-col col-md-3 hidden-sm hidden-xs">
      ...
      <div class="trail-col col-md-13 col-sm-16">
