...
window.cmap.global.anchors.crawl = window.cmap.global.anchors.crawl || function(){
	...
	var $button = $('<button class="page-anchor-button"><span class="sr-only">'+name+'</span><img class="page-anchor-icon" src="/o/cmap-2019-theme/images/icons/ic_clipboard.svg" /></button>');
