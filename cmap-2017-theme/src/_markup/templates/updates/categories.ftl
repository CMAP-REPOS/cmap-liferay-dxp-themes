		...
		<div class="updates-filter-type">
			...
			<#list curVocabulary.getCategories() as sub >
				<#if sub.name == 'All Updates'>
					<a href="/updates/all">All</a>
				</#if>
				<#if sub.name == 'Policy Updates'>
					<a href="/updates/all/-/categories/${sub.categoryId}" data-catid="${sub.categoryId}">Policy</a>
				</#if>
				<#if sub.name == 'Weekly Updates'>
					<a href="/updates/all/-/categories/${sub.categoryId}" data-catid="${sub.categoryId}">Weekly</a>
				</#if>
				<#if sub.name == 'Legislative Updates'>
					<a href="/updates/all/-/categories/${sub.categoryId}" data-catid="${sub.categoryId}">Legislative</a>
				</#if>
			</#list>
		</div>
		</#if>
