...
<section class="featured-card 2019" id="${randomNamespace}">
  <div class="featured-card-main col-md-10 col-md-offset-3 col-sm-16 col-sm-offset-0">
    <div class="row">
      <div class="col-md-8">
        <#if file?? && file != "">
...
<section class="featured-card 2017" id="${randomNamespace}">
  <div class="row">
    <div class="col-xl-8">
      <#if file?? && file != "">
      <a class="featured-card-img-link" href="${link}">
