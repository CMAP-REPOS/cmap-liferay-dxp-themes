  ...
  <nav class="nav-row-one row">
    ...
    <div class="right col-xl-4 col-sm-6 col-xs-8">
      <div class="search-widget">
        <span id="site-search-button" class="search-widget-decorators">
        ...
        <input id="site-search-input" class="search-widget-field" id="header-search-field" type="text" aria-describedby="site-search-addon">
      </div>
    </div>
  </nav>
