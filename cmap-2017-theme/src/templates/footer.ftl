<footer id="footer" role="contentinfo">
  <div class="container">
    ...
    <div class="row">
      ...
      <div id="jump-to-top" class="col-xl-3 col-md-2 col-sm-16 footer-jump-to-top" aria-label="Jump to top">
      ...
      <div class="col-xl-10 col-md-12 col-sm-16 col-sm-offset-0 footer-page-links" aria-label="Site Pages">
      ...
      <div class="col-xl-3 col-md-2 col-sm-16 footer-social-links" aria-label="Links to social media websites">
        ...
        <a class="youtube-link footer-social-link" href="https://www.youtube.com/channel/UCnDGzjtkedIHgDg-O44Yq6A" target="_blank">
          <svg class="youtube svg-icon" viewBox="0 0 20 20">
