<footer id="footer" role="contentinfo">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-xl-10 col-md-12 col-sm-16 col-sm-offset-0 footer-page-links" aria-label="Site Pages" role="menubar">
      ...
      <div class="col-xl-3 col-md-2 col-sm-16 footer-social-links" aria-label="Links to social media websites">
        ...
        <a class="twitter-link footer-social-link" href="" target="_blank">
        ...
        <a class="facebook-link footer-social-link" href="" target="_blank">
        <svg class="facebook svg-icon" viewBox="0 0 20 20">
          <path fill="none" d="M11.344,5.71c0-0.73,0.074-1.122,1.199-1.122h1.502V1.871h-2.404c-2.886,0-3.903,1.36-3.903,3.646v1.765h-1.8V10h1.8v8.128h3.601V10h2.403l0.32-2.718h-2.724L11.344,5.71z"></path>
        </svg>
      </a>

        <a class="youtube-link footer-social-link" href="" target="_blank">
        ...
        <a class="instagram-link footer-social-link" href="" target="_blank">
