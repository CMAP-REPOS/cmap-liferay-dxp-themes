<div class="fullbackgroundimage1212210" id="main-content" role="main">
    ...
    <table class="portlet-layout">
      <tr>
        <td colspan="3" class="portlet-column" id="column-4">
    ...
    <table class="portlet-layout">
      <tr>
        <td width="30%" class="portlet-column portlet-column-first secondary" id="column-2">
          <p class="menu-heading">More in this section:</p>
          <!-- processor.processPortlet("71_INSTANCE_Nj25") -->
          $processor.processColumn("column-2", "portlet-column-content portlet-column-content-first")
        </td> <!-- .portlet-column -->
        
        <td colspan="2" width="70%" class="portlet-column portlet-column-last primary" id="column-3">
          <!-- processor.processPortlet("73_INSTANCE_Nj25") -->
