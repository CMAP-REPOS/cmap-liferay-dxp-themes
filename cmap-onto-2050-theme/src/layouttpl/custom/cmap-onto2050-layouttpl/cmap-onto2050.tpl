<div class="container-fluid" id="main-content" role="main">
	<div class="portlet-layout row">
		<div class="col-md-16 portlet-column portlet-column-only" id="column-1">
	...
	<div class="portlet-layout row">
		...
		<div class="col-md-8 portlet-column" id="column-3">
	...
	<div class="portlet-layout row">
		<div class="col-md-16 portlet-column portlet-column-only" id="column-5">
	...
	<div class="portlet-layout row">
		...
		<div class="col-md-8 portlet-column" id="column-7">
	...
	<div class="portlet-layout row">
		<div class="col-md-16 portlet-column portlet-column-only" id="column-9">
