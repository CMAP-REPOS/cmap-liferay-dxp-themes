...
window.cmap.global.anchors.crawl = window.cmap.global.anchors.crawl || function(){
	...
	var $button = $('<button class="page-anchor-button"><span class="sr-only">'+name+'</span><img aria-label="page-anchor-icon" class="page-anchor-icon" src="/o/cmap-onto-2050-theme/images/icons/ic_clipboard.svg" /></button>');
